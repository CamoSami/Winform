...
namespace WinformWithExternalLibrary.DataValidateObjects
{
	public class HoaDonNhapDVO
	{
		...
		public HoaDonNhapDVO(Guid hoaDonNhapDTO_MaNhaCungCap, Guid hoaDonNhapDTO_MaNhanVien, DateTime hoaDonNhapDTO_NgayNhap, int hoaDonNhapDTO_SoSanPham, int hoaDonNhapDTO_GiamGia, int hoaDonNhapDTO_TongTien)
		{
