...
namespace WinformWithExternalLibrary.DataValidateObjects
{
    public class NhanVienDVO
    {
        ...
        public NhanVienDVO(Guid nhanVienDTO_MaCongViec, string nhanVienDTO_TenNhanVien, DateTime nhanVienDTO_NgaySinh, string nhanVienDTO_DiaChi, string nhanVienDTO_DienThoai, string nhanVienDTO_GioiTinh)
        {
