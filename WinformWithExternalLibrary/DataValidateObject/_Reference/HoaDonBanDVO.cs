...
namespace WinformWithExternalLibrary.DataValidateObjects
{
	public class HoaDonBanDVO
	{
		...
		public HoaDonBanDVO(Guid hoaDonBanDTO_MaKhachHang, Guid hoaDonBanDTO_MaNhanVien, DateTime hoaDonBanDTO_NgayBan, int hoaDonBanDTO_SoSanPham, int hoaDonBanDTO_GiamGia, int hoaDonBanDTO_TongTien)
		{
